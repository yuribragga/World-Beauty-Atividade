...
export default function Home() {
    ...
    const fetchClientesMaisConsumidores = () => {
        axios.get('http://localhost:32832/clientes/maisConsumidores')
            .then(response => {
    ...
    const ClientesMaisConsumidoresValor = ()=>{
        axios.get('http://localhost:32832/clientes/maisConsumidoresValor')
        .then(response => {
            console.log(response.data); 
    ...
    const fetchProdutosMaisConsumidos = ()=>{
        axios.get('http://localhost:32832/produtos/maisConsumidos')
        .then(response => {
    ...
    const fetchServicosMaisConsumidos = ()=>{
        axios.get('http://localhost:32832/servicos/maisConsumidos')
        .then(response => {
    ...
    const produtosGeneroFemininoRequest = () => {
        axios.get('http://localhost:32832/produtos/maisConsumidosPorGenero/Feminino')
            .then((response) => {
    ...
    const produtosGeneroMasculinoRequest = () => {
        axios.get('http://localhost:32832/produtos/maisConsumidosPorGenero/Masculino')
            .then((response) => {
                const produtosConsumidos: QntProduto[] = response.data.map((item: any) => ({
                    produtoNome: item.produtoNome,
                    count: item.count
    ...
    const servicosGeneroFemininoRequest = () => {
        axios.get('http://localhost:32832/servicos/maisConsumidosPorGenero/Feminino')
            .then((response) => {
                console.log('Dados de serviços por gênero feminino:', response.data); 
    ...
    const servicosGeneroMasculinoRequest = () => {
        axios.get('http://localhost:32832/servicos/maisConsumidosPorGenero/Masculino')
            .then((response) => {
                console.log('Dados de serviços por gênero masculino:', response.data);
                const servicosConsumidos: QntServico[] = response.data.map((item: any) => ({
                    servicoNome: item.servicoNome,
                    count: item.count
                }));
